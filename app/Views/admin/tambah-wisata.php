                        ...
                        <form action="post-wisata" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="waktuPerjalanan" name="waktu_perjalanan" placeholder="Masukkan durasi perjalanan dalam hari" value="<?= old('waktu_perjalanan') ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control" id="rutePerjalanan" name="rute_perjalanan" rows="3" placeholder="Masukkan rute perjalanan..." required><?= old('rute_perjalanan') ?></textarea>
                                </div>
                            </div>
